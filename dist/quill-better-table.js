...
module.exports = "<?xml version=\"1.0\" standalone=\"no\"?><!doctype html><svg class=icon width=20px height=20px viewBox=\"0 0 24 24\" version=1.1 xmlns=http://www.w3.org/2000/svg><path fill=#595959 d=\"M23 26H1a1 1 0 100 2h22a1 1 0 100-2zM14.866 3.232l2.598 1.5-1 1.731-2.598-1.5 1-1.73zM8.964 19.454l-2.598-1.5 6.5-11.258 2.598 1.5-6.5 11.258zM4.665 23.9a1 1 0 00.97.017l4.164-2.214c.166-.088.303-.22.397-.383l9.5-16.454A1.002 1.002 0 0019.33 3.5L15 1a.998.998 0 00-1.366.366l-9.5 16.454c-.094.162-.14.348-.134.535l.165 4.714c.012.302.157.58.393.76l.107.071z\"/></svg>";
